...
CREATE TABLE IF NOT EXISTS configuracion_tienda (
    ...
    color_secondary_h   INTEGER         DEFAULT 220,
    color_secondary_s   INTEGER         DEFAULT 60,
    color_secondary_l   INTEGER         DEFAULT 50,
    atenuacion          INTEGER         DEFAULT 10,
    home_image_url      VARCHAR(500),
    login_image_url     VARCHAR(500),
    register_image_url  VARCHAR(500),
    about_image_url     VARCHAR(500),
    footer_light_text   BOOLEAN         DEFAULT TRUE,
    created_at          TIMESTAMPTZ     NOT NULL DEFAULT now(),
    updated_at          TIMESTAMPTZ     NOT NULL DEFAULT now()
);
